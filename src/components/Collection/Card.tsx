      ...
      <div className="card-body">
        ...
        <div className="h-fit flex">
        {
          collection.rating > 0 ? (
            ...
            <svg className="w-3 h-3 text-customorange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex items-center gap-2">
          <img
            ...
            src={collection.user.picture ? collection.user.picture : "https://via.placeholder.com/150"}
            alt=""
          />
